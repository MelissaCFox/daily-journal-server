...
from views import (get_all_entries, get_single_entry, create_entry, delete_entry,
                   update_entry, get_entry_search_results, get_all_moods,
                   get_single_mood, create_mood, delete_mood, update_mood,
